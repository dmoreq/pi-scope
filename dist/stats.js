...
export class SessionStats {
    ...
    mentionCounts = new Map(); // file → times mentioned
    injectedFiles = new Set(); // ever injected this session
    constructor(sessionId) {
        this.sessionId = sessionId;
    }
    /** Call when the repo map is injected into the system prompt. */
    recordRepoMapInjection(tokens) {
     ...
     */
    recordDepContextInjection(injectedFilePaths, tokens) {
     ...
     */
    recordContextFilesInjection(tokens, count) {
     ...
     */
    recordProviderGuidanceInjection(tokens, count) {
    ...
    report() {
        const lines = ['── smart-context session stats ──────────────────'];
