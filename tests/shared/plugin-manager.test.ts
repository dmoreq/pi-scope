...
import { PluginError, PluginManager } from '../../plugins/plugin-manager.js'
...
describe('PluginManager', () => {
  ...
  describe('hook execution', () => {
    ...
    it('continues execution after a plugin error', async () => {
      ...
      await expect(manager.runHook('onSessionStart', {} as any)).resolves.toBeUndefined()
  ...
  describe('tool call interception', () => {
    it('allows tool calls by default', async () => {
      const result = await manager.runToolCall({ toolName: 'read', input: {} }, {} as any)
